...
print('Strenght Combat Correlation : ',sc_pearson)
ic_df = data[['Intelligence','Combat']]
ic_covariance = ic_df.cov().loc['Intelligence','Combat']
ic_intelligence = ic_df['Intelligence'].std()
ic_combat = ic_df['Combat'].std()
ic_pearson = ic_covariance/(ic_intelligence*ic_combat)
print('Intelligence Combat Correlaation : ',ic_pearson)
...
fig,(ax_1,ax_2,ax_3) = plt.subplots(nrows = 1,ncols = 3, figsize=(12,5))
